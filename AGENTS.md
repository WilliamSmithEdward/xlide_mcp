...
python/            the reference implementation
  ...
  tests/           238 without Office, 12 more with
...
2. `cd python && python -m pytest` - 238 tests, no Office needed.
...
A refusal is as much of the contract as a success: 16 of the 61 conformance cases
