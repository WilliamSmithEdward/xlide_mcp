...
python/            the reference implementation
  ...
  tests/           171 without Office, 11 more with
...
2. `cd python && python -m pytest` - 171 tests, no Office needed.
...
A refusal is as much of the contract as a success: 14 of the 46 conformance cases
