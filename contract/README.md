...
| `conformance.json` | What the answers mean: 98 conformance cases, each a short script of calls and assertions. | `python tools/export_conformance.py` |
...
with that text in the message. 24 of the 98 conformance cases are refusals: what
