...
| `conformance.json` | What the answers mean: 88 conformance cases, each a short script of calls and assertions. | `python tools/export_conformance.py` |
...
with that text in the message. 24 of the 88 conformance cases are refusals: what
