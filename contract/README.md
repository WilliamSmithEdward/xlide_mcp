...
| `conformance.json` | What the answers mean: 36 cases, each a short script of calls and assertions. | `python tools/export_conformance.py` |
...
with that text in the message. Thirteen of the cases are refusals: what a server
