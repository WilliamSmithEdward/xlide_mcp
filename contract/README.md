...
| `conformance.json` | What the answers mean: 81 conformance cases, each a short script of calls and assertions. | `python tools/export_conformance.py` |
...
with that text in the message. 22 of the 81 conformance cases are refusals: what
