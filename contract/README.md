...
| `conformance.json` | What the answers mean: 84 conformance cases, each a short script of calls and assertions. | `python tools/export_conformance.py` |
...
with that text in the message. 23 of the 84 conformance cases are refusals: what
